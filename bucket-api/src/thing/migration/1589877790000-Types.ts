    ...
    const propertyTypes: PropertyType[] = [
        ...
        },
        {
          ...
          dimensions: [
            ...
            {
              id: "local-ip-address-type",
              name: "Type Local IP",
              description: "Type Local IP",
              unit: "",
              type: "number",
            },
            {
            ...
            {
              id: "external-ip-address-type",
              name: "Type External IP",
              description: "Type External IP",
              unit: "",
              type: "number",
            },
          ],
        },
        {
          ...
          dimensions: [
            ...
            },
            {
              id: "dns-local",
              name: "Local domain",
              description: "The local domain name (usually [hostname].local)",
              unit: "",
              type: "string",
            },
            {
              ...
              name: "FQDN",
              description:
                "The Fully Qualified Domain Name, accessible from the Internet external networks.",
              unit: "",
              type: "string",
            },
          ],
      ...
      propertyTypeRepository = getRepository(PropertyType);
